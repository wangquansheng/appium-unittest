...
class VoiceAnnouncementTest(TestCase):
    ...
    def test_YYTZ_0008(self):
        ...
        sc.click_sure_bottom()
        time.sleep(2)
        if not vnp.is_text_present("飞信电话"):
    ...
    def test_YYTZ_0010(self):
        ...
        if not sc.swipe_and_find_element("bm0"):
            ...
            sc.click_text("选择企业通讯录联系人")
            time.sleep(2)
            SelectContactsPage().click_one_contact_631("bm0")
            aa = sc.get_firm_contacts_name_list()
            sc.click_text(aa[0])
            time.sleep(2)
            sc.click_text(aa[0])
    ...
    def test_YYTZ_0053(self):
        ...
        time.sleep(3)
        if not sc.is_text_present("飞信电话"):
            raise AssertionError("搜索结果有误")
    ...
    def test_YYTZ_0056(self):
        ...
        if sc.swipe_and_find_element("bm1"):
            ...
            sc.click_text("选择企业通讯录联系人")
            time.sleep(2)
            SelectContactsPage().click_one_contact_631("bm1")
            time.sleep(2)
            aa = sc.get_firm_contacts_name_list()
            sc.click_text(aa[0])
            current_mobile().back()
            SelectContactsPage().click_one_contact_631("bm2")
            time.sleep(2)
            sc.click_text(aa[1])
            if not sc.is_text_present("2/1000"):
                raise AssertionError("部门人数不可以叠加")
    ...
    #     time.sleep(2)
    #     SelectContactsPage().click_one_contact_631(names[0])
    #     SelectContactsPage().click_one_contact_631(names[1])
    #     SelectContactsPage().click_one_contact_631(names[2])
    #     time.sleep(2)
    #     sc.click_sure_bottom()
