...
class SuperMeetingPage(BasePage):
    ...
    __locators = {
        ...
        # '预约会议': (MobileBy.XPATH, '//*[contains(@text,"预约会议")]'),
        '预约会议': (MobileBy.XPATH, '//*[@text="预约会议" or @content-desc="预约会议"]'),
        ...
        '时间小时': (MobileBy.ID, 'hourSelectList'),
    }

    @TestLogger.log()
    def wait_for_page_loads(self, text="预约会议", timeout=60):
        """等待 页面加载"""
        try:
            self.wait_until(
