...
class ChatMorePage(BasePage):
    ...
    __locators = {'': (MobileBy.ID, ''),
                  ...
                  '文件': (MobileBy.XPATH, '//*[@text="文件" or @content-desc="文件"]'),
                  '文件图标': (MobileBy.ID, 'com.chinasofti.rcs:id/ib_file'),
                  '群短信': (MobileBy.XPATH, '//*[@text="群短信" or @content-desc="群短信"]'),
                  '位置': (MobileBy.XPATH, '//*[@text="位置" or @content-desc="位置"]'),
                  '红包': (MobileBy.XPATH, '//*[@text="红包" or @content-desc="红包"]'),
